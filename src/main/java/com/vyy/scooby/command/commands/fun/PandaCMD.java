...
public class PandaCMD extends Command {
    public PandaCMD() {
        super.commandName = "panda";
        super.help = "Retrieves a cute picture of a panda";
        super.cooldown = 1;
    }

    @Override
    protected void handle(CommandContext commandContext) {
        JSONObject jsonObject = WebUtils.parseJson("https://some-random-api.ml/img/panda");
